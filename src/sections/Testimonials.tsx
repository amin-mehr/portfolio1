...
const testimonials = [
  ...
  },
  {
    ...
    text: "امین واقعاً یک جادوگر فرانت‌اند است! محصول پیچیده ما را به رابط کاربری ساده و جذابی تبدیل کرد. بازخوردهای مثبت مشتریان‌مان از همین حالا شروع شده.",
  ...
  },
  {
    ...
    text: "کار امین روی وب‌سایت ما فوق‌العاده بود. او یک توسعه‌دهنده‌ی بااستعداد و همچنین یک ارتباط‌گیر حرفه‌ای است. همکاری با او را به‌شدت توصیه می‌کنیم.",
